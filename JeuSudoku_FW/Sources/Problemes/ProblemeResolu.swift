...
public struct ProblemeResolu: UnLitteral, Identifiable {
...
public extension ProblemeResolu {
...
public extension ProblemeResolu {
    static var predefinis: [ProblemeResolu] {
        [
            ProblemeResolu(
            ...
            ProblemeResolu(
                ...
                signature: SignatureCoup(typeCoup: .eliminationDirecte, typeZone: "carre", nbDirects: 4, nbIndirects: 0, nbPaires2: 0, nbTriplets3: 0)),
            ProblemeResolu(
